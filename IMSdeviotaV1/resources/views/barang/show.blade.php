...
<style>
    ...
    .product-photos {
        ...
        /* Membuat 4 kolom untuk gambar yang lebih kecil */
        gap: 15px;
    ...
    .product-photos .photo-container {
        ...
        /* Ukuran lebih kecil */
        overflow: hidden;
        /* Agar gambar tidak melampaui batas */
        border: 1px solid #ddd;
        background-color: white;
    ...
    .product-photos img {
        ...
        height: 100%;
        object-fit: cover;
        /* Memastikan gambar menyesuaikan ruang tanpa pecah */
    }
    ...
    .back-button:hover {
        background-color: #5e148f;
        box-shadow: 0 6px 12px rgba(94, 20, 143, 0.5);
...
<div class="product-detail-container">
    <h2 class="detail-header">DETAIL asdasd</h2>
